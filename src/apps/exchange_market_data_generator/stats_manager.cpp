...
void StatsManager::updateTradeStats(const std::string& symbol, size_t quantity, double price) {
    auto& stats = _symbolStats[symbol];
    stats.trades++;
...
void StatsManager::printStats(size_t totalMessages, double elapsedSeconds) const {
    std::cout << "\n";
    std::cout << "═══════════════════════════════════════════════════════════════════════════════════════════════════════\n";
